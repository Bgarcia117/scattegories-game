    ...
    <div className='Categories'>
      <div className='Categories-Main'>
        ...
        <ol className="Categories-Main-Display">
          {/* Using the Map method to create lis (AKA List itmes) using the categories for the current list. The current list is determined by the current value for the "list" state value */}
